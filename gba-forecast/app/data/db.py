...
No hardcoded creds, parameterized queries (no f-string SQL), pool with pre-ping + recycle.
"""
...
def get_engine() -> Engine:
    ...
    if _engine is None:
        ...
        _engine = create_engine(
            ...
            pool_recycle=3600,
            connect_args={
                "login_timeout": s.db_login_timeout_seconds,
                "timeout": s.db_query_timeout_seconds,
            },
            echo=False,
        )
    return _engine
